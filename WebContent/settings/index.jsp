	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='logout';">确定</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div style="position: relative; width: 55%; height: 70%; left: 22%;">
			...
			<div style="position: relative; width: 33%; height: 50%;">
				...
				<a href="settings/org/index.jsp" style="text-decoration: none; color: red;">组织机构</a>
				<br>
				<a href="settings/dept/index.jsp" style="text-decoration: none; color: red;">部门管理</a>
				<br>
				<a href="settings/qx/index.jsp" style="text-decoration: none; color: red;">权限管理</a>
			</div>
