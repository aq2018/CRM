...
<script type="text/javascript" src="js/settings/qx/index.js"></script>
<script type="text/javascript" src="js/settings/org/index.js"></script>
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
					...
					<form class="form-horizontal" role="form">
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								...
								<span id="tip1" style="font-size: 16px;color: red;"></span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								...
								<span id="tip2" style="font-size: 16px;color: red;"></span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								...
								<span id="tip3" style="font-size: 16px;color: red;"></span>
							</div>
						</div>
					</form>
				</div>
				<div class="modal-footer">
					...
					<button id="resetPwd" type="button" class="btn btn-primary">更新</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-dialog" role="document" style="width: 80%;">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<input type="hidden" class="form-control" id="create-pId" style="width: 200%;">
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10" style="width: 570px;">
									<select class="form-control" id="create-marketActivityOwner">
									  <option value=""></option>
									  <c:forEach items="${orgTypeList}" var="o">
									   <option>${o.content}</option>
									  </c:forEach>
									</select>
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" role="form">
							...
							<div class="form-group">
								...
								<div class="col-sm-10" style="width: 300px;">
									<input type="text" class="form-control" id="edit-orgCode" style="width: 200%;">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10" style="width: 300px;">
									<input type="text" class="form-control" id="edit-orgName" style="width: 200%;">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10" style="width: 570px;">
									<textarea class="form-control" rows="3" id="edit-orgDescribe"></textarea>
								</div>
							</div>
						</form>
					</div>
					<div class="modal-footer">
						<span id="editTip" style="color: red;font-size: 14px"></span>
						<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
		...
		<div style="position: absolute; width: 80%; height: 100%; overflow: auto; left: 20%;">
			...
			<div style="position: relative; left: 30px; top: -10px;">
				<div class="page-header">
					<h3 id="o_title">xx公司<small>&nbsp;机构明细 </small></h3>
					<input type="hidden" class="form-control" id="o-orgId" style="width: 50%;">
				</div>
				<div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 60%;">
					...
					<button id="edit" type="button" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
					<button type="button" id="del" class="btn btn-danger"><span class="glyphicon glyphicon-minus"></span> 删除</button>
				</div>
			</div>
			<!-- 详细信息 -->
			<div style="position: relative; top: -70px;">
				<div style="position: relative; left: 40px; height: 30px; top: 20px;">
					...
					<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="o_code">&nbsp;</b></div>
				...
				<div style="position: relative; left: 40px; height: 30px; top: 40px;">
					...
					<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="o_name">&nbsp;</b></div>
					<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
				</div>
				<div style="position: relative; left: 40px; height: 30px; top: 60px;">
					<div style="width: 300px; color: gray;">机构类型</div>
					<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="o_orgType">&nbsp;</b></div>
					<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
				</div>
				<div style="position: relative; left: 40px; height: 30px; top: 80px;">
					<div style="width: 300px; color: gray;">负责人</div>
					<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="o_manager">&nbsp;</b></div>
					<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
				</div>
				<div style="position: relative; left: 40px; height: 30px; top: 100px;">
					<div style="width: 300px; color: gray;">创建者</div>
					<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="o_createBy">&nbsp;</b><small id="o_createTime" style="font-size: 10px; color: gray;">&nbsp;</small></div>
					<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
				</div>
				<div style="position: relative; left: 40px; height: 30px; top: 120px;">
					<div style="width: 300px; color: gray;">修改者</div>
					<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="o_editBy">&nbsp;&nbsp;</b><small id="o_editTime" style="font-size: 10px; color: gray;">&nbsp;</small></div>
					<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
				</div>
