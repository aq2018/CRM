...
<script type="text/javascript" src="js/settings/dictionary/type/save.js"></script>
</head>
<body>
	<!-- save.html -->
	...
	<form id="saveForm" class="form-horizontal" role="form" action="settings/dictionary/type/addType.do">
					
		<div class="form-group">
			<label for="create-code" class="col-sm-2 control-label">编码<span style="font-size: 15px; color: red;">*</span></label>
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="code" name="type" style="width: 200%;" placeholder="编码作为主键，不能是中文">
