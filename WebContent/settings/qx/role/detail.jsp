...
<SCRIPT type="text/javascript">
	...
	var zNodes =[
		...
		{ id:1, pId:0, name:"市场活动1" , open : true},
	...
	$(document).ready(function(){
		...
		$("#distribution").click(function(){
			...
			alert("分配许可id"+sendData);
			/* $.post(
				"settings/qx/role/distributionPermission",
				sendData.substr(1),
				function(json){
					if(json.success){
		...
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button id="distribution" type="button" class="btn btn-primary" data-dismiss="modal">分配</button>
				</div>
			</div>
		</div>
	</div>
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="hidden" class="form-control" id="h-roleId" style="width: 200%;" value="${role.id}">
								<input type="text" class="form-control" id="edit-roleCode" style="width: 200%;" value="${role.no }">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-roleName" style="width: 200%;" value="${role.name}">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 65%;">
								<textarea class="form-control" rows="3" id="edit-describe">${role.description}</textarea>
							</div>
						</div>
					</form>
				</div>
			...
			<div class="tab-pane fade in active" id="role-info">
				<div style="position: relative; top: 20px; left: -30px;">
					<div style="position: relative; left: 40px; height: 30px; top: 20px;">
						...
						<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="r-no">${role.no}&nbsp;</b></div>
						<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
					</div>
					<div style="position: relative; left: 40px; height: 30px; top: 40px;">
						<div style="width: 300px; color: gray;">名称</div>
						<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="r-name">${role.name}&nbsp;</b></div>
						<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
					</div>
					<div style="position: relative; left: 40px; height: 30px; top: 60px;">
						<div style="width: 300px; color: gray;">描述</div>
						<div style="width: 200px;position: relative; left: 200px; top: -20px;"><b id="r-desc">${role.description}&nbsp;</b></div>
						<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
