...
<script type="text/javascript" src="js/settings/qx/user/detail.js"></script>
<SCRIPT type="text/javascript">
	...
	$(document).ready(function(){
		...
		//根据从count取得编辑信息
		/* $.get(
			"settings/qx/user/getByAccount.do",
		...
		$("#editBtn").click(function(){
			$("#edit-lockStatus").val("${userMap.lockState}")
		})
					...
					<form id="editForm" class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-account" name="account" value="${userMap.account}">
								<input type="hidden" class="form-control" id="edit-id" name="id" value="${userMap.id}">
								<span id="accountTip" style="color: red;font-size: 12px"></span>
							</div>
							<label for="edit-username" class="col-sm-2 control-label">用户姓名</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-username" name="username" value="${userMap.username }">
								<span id="usernameTip" style="color: red;font-size: 12px"></span>
							</div>
						</div>
						<div class="form-group">
							<label for="edit-loginPwd" class="col-sm-2 control-label">登录密码<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="password" class="form-control" id="edit-password" name="password" value="${userMap.password }">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="password" class="form-control" id="edit-confirmPwd" value="${userMap.password }">
								<span id="confpwdTip" style="color: red;font-size: 12px"></span>
							</div>
						</div>
						<div class="form-group">
							<label for="edit-email" class="col-sm-2 control-label">邮箱</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-email" name="email" value="${userMap.email }">
								<span id="emailTip" style="color: red;font-size: 12px"></span>
							</div>
							<label for="edit-expireTime" class="col-sm-2 control-label">失效时间</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-expireTime" name="invalid_time" value="${userMap.invalid_time }">
							</div>
						</div>
						<div class="form-group">
							<label for="edit-lockStatus" class="col-sm-2 control-label">锁定状态</label>
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="edit-lockStatus" name="state">
								   <option></option>
								  <option>启用</option>
								  <option>锁定</option>
								</select>
								<span id="stateTip" style="color: red;font-size: 12px"></span>
							</div>
							<label for="create-org" class="col-sm-2 control-label">部门名称<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="hidden" class="form-control" id="deptno">
								<input type="text" autocomplete="off" class="form-control" id="create-org" name="deptname" placeholder="输入部门名称，自动补全" value="${userMap.deptname}">
								<span id="deptTip" style="color: red;font-size: 12px"></span>
							</div>
						</div>
						<div class="form-group">
							<label for="edit-allowIps" class="col-sm-2 control-label">允许访问的IP</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-allowIps" name="permit_ip" style="width: 280%" placeholder="多个用逗号隔开" value="${userMap.permit_ip }">
							</div>
						</div>
					</form>
				</div>
	...
	<div>
		<div style="position: relative; left: 30px; top: -10px;">
			<div class="page-header">
				<h3>用户明细 <small>${userMap.username}</small></h3>
			</div>
			...
			<div class="tab-pane fade in active" id="role-info">
				<div style="position: relative; top: 20px; left: -30px;">
					<div style="position: relative; left: 40px; height: 30px; top: 20px;">
						...
						<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="u-account">${userMap.account}&nbsp;</b></div>
					...
					<div style="position: relative; left: 40px; height: 30px; top: 40px;">
						...
						<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="u-username">${userMap.username}&nbsp;</b></div>
						<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
					</div>
					<div style="position: relative; left: 40px; height: 30px; top: 60px;">
						<div style="width: 300px; color: gray;">邮箱</div>
						<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="u-email">${userMap.email}&nbsp;</b></div>
						<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
					</div>
					<div style="position: relative; left: 40px; height: 30px; top: 80px;">
						<div style="width: 300px; color: gray;">失效时间</div>
						<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="u-invalid_time">${userMap.invalid_time}&nbsp;</b></div>
						<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
					</div>
					<div style="position: relative; left: 40px; height: 30px; top: 100px;">
						<div style="width: 300px; color: gray;">允许访问IP</div>
						<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="u-permit_ip">${userMap.permit_ip}&nbsp;</b></div>
						<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
					</div>
					<div style="position: relative; left: 40px; height: 30px; top: 120px;">
						<div style="width: 300px; color: gray;">锁定状态</div>
						<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="u-lockState">${userMap.lockState}&nbsp;</b></div>
						<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
					</div>
					<div style="position: relative; left: 40px; height: 30px; top: 140px;">
						<div style="width: 300px; color: gray;">部门名称</div>
						<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="u-deptname">${userMap.deptname}&nbsp;</b></div>
						<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
						<button id="editBtn" style="position: relative; left: 76%; top: -40px;" type="button" class="btn btn-default" data-toggle="modal" data-target="#editUserModal"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
					</div>
				</div>
			</div>
