...
<script type="text/javascript" src="js/settings/qx/permission.js"></script>
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="hidden" class="form-control" id="h-id" style="width: 200%;">
	...
	<div style="position: absolute; width: 80%; height: 100%; overflow: auto; left: 20%;">
		...
		<div style="position: relative; left: 30px; top: -10px;">
			<div class="page-header">
				<h3 id="t-name">&nbsp;<small>许可明细</small></h3>
			</div>
			<div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 60%;">
				<button onclick="add()" type="button" class="btn btn-primary" data-toggle="modal" data-target="#createPermissionModal"><span class="glyphicon glyphicon-plus"></span> 新增</button>
				<button id="edit" type="button" class="btn btn-default" data-toggle="modal"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
			</div>
		</div>
		<!-- 详细信息 -->
		<div style="position: relative; top: -70px;">
			<div style="position: relative; left: 40px; height: 30px; top: 20px;">
				...
				<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="p-name">&nbsp;</b></div>
			...
			<div style="position: relative; left: 40px; height: 30px; top: 40px;">
				...
				<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="p-modalURL">&nbsp;</b></div>
				<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
			</div>
			<div style="position: relative; left: 40px; height: 30px; top: 60px;">
				<div style="width: 300px; color: gray;">操作URL</div>
				<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="p-operateURL">&nbsp;</b></div>
				<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
			</div>
			<div style="position: relative; left: 40px; height: 30px; top: 80px;">
				<div style="width: 300px; color: gray;">排序号</div>
				<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="p-sortNo">&nbsp;</b></div>
				<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
			</div>
		</div>
	</div>
