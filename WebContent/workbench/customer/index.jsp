		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button id="createBtn" type="button" class="btn btn-primary" data-toggle="modal" data-target="#createCustomerModal"><span class="glyphicon glyphicon-plus"></span> 创建</button>
				...
				<div class="btn-group" style="position: relative; top: 18%;">
				  ...
				  <button id="exportChk" type="button" class="btn btn-default"><span class="glyphicon glyphicon-export"></span> 导出选中</button>
				  <button id="exportAll" type="button" class="btn btn-default"><span class="glyphicon glyphicon-export"></span> 导出全部</button>
				</div>
			</div>
				...
				<table class="table table-hover">
					...
					<tbody id="tbody">
						<!-- <tr>
							...
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/customer/detail.html';">某某某公司</a></td>
							<td>zhangsan</td>
							<td>010-84846003</td>
