					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								...
								<input type="text" autocomplete="off" class="form-control" id="edit-customerName" placeholder="支持自动补全，输入客户不存在则新建" value="某某某公司">
							</div>
						</div>
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="hidden" id="h-fullname">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="hidden" id="q-customName">
				      <input class="form-control" type="text" id="h-customName">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">来源</div>
				        <input class="form-control" type="hidden" id="h-clueSource">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="hidden" id="q-birth">
				      <input class="form-control" type="text" id="h-birth">
				    </div>
				  </div>
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 10px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button id="createBtn" type="button" class="btn btn-primary" data-toggle="modal" data-target="#createContactsModal"><span class="glyphicon glyphicon-plus"></span> 创建</button>
				...
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button id="importBtn" type="button" class="btn btn-default" data-toggle="modal" data-target="#importContactsModal"><span class="glyphicon glyphicon-import"></span> 导入</button>
			...
			<div style="position: relative;top: 20px;">
				<table class="table table-hover">
					...
					<tbody id="tbody">
						<!-- <tr>
							<td><input type="checkbox" name="contact" value="2"/></td>
