					...
					<form id="addForm" class="form-horizontal" role="form" action="">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-clueOwner" name="p_user_id">
								...
								<span id="clueOwnerTip" style="color: red;font-size: 12px"></span>
							</div>
							<label for="create-company" class="col-sm-2 control-label">公司<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="create-company">
								<span id="companyTip" style="color: red;font-size: 12px"></span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-calls">
								 <option></option>
								  <!-- <option value=""></option>
								  <option>先生</option>
								  <option>夫人</option>
								...
								<span id="callsTip" style="color: red;font-size: 12px"></span>
							</div>
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-company" value="某某某公司">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-tel" value="010-84846003">
							</div>
	...
	<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;" action="workbench/clue/getByCondition.do?pageNo=1&pageSize=10">
				  
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">名称</div>
				      <input class="form-control" type="text" id="q-surname">
				      <input class="form-control" type="hidden" id="h-surname">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="hidden" id="h-company">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="text" id="q-tel">
				      <input class="form-control" type="hidden" id="h-tel">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="hidden" id="h-source">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input id="q-owner" class="form-control" type="text">
				      <input id="h-owner" class="form-control" type="hidden">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="hidden" id="h-phone">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="hidden" id="h-state">
